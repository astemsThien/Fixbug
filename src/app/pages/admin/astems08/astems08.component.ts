...
import {Astems08Service, UserVO,MenuSearchVO} from './astems08.service';
...
@Component({
  selector: 'app-astems08',
  templateUrl: './astems08.component.html',
  styleUrls: ['./astems08.component.scss']
})
export class Astems08Component implements OnInit {
  ...
  constructor(public utilService: CommonUtilService,
              private service: Astems08Service,
