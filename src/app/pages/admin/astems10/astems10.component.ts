...
import {Astems10Service} from './astems10.service';

@Component({
  selector: 'app-astems10',
  templateUrl: './astems10.component.html',
  styleUrls: ['./astems10.component.scss']
})
export class Astems10Component implements OnInit, AfterViewInit {
  ...
  constructor(public utilService: CommonUtilService,
              private service: Astems10Service,
  ...
  onFocusedRowChanging1(e): void {
    // this.initGrid();
    const DataAnalyst = e.row.data.codeCategory;
    const DataAnalysts = e.row.data.name;
    console.log(DataAnalyst,DataAnalysts)
      this.mainForm.formData.codeCategory = DataAnalyst;
      this.mainForm.formData.name = DataAnalysts;
