...
import {MenuSearchVO, Astems02Service} from './astems02.service';
...
@Component({
  ...
  templateUrl: './astems02.component.html',
  styleUrls: ['./astems02.component.scss']
})
export class Astems02Component implements OnInit {
